    ...
    <div class="flex rounded-lg bg-white flex-col shadow-md">
        <section class="bg-white dark:bg-gray-900 ">
            <div class="py-8 px-4 mx-auto">
                <h2 class="text-gray-900 dark:text-white text-lg font-medium mb-4">Update Status:</h2>

                <form action="{{route('updateStatus',['order_id'=>$order_id,'payment_id'=>$payment_id])}}" method="POST">
                    @csrf
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        <div>
                            <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Payment Status:</label>
                            <select name="paymentStatus" id="pstatus" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        ...
                        <div>
                            <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Order Status:</label>
                            <select name="orderStatus" id="ostatus" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                <option value="Pending">Pending</option>
