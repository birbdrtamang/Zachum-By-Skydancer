...
<div class="p-4 sm:ml-64" style="margin-top:90px"> 
    ...
    <h2 class="text-gray-900 dark:text-white text-lg font-medium mb-4">Payments</h2>
          ...
          @foreach ($payment as $payment)
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
               <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white">
                ...
                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white">
                  <a style="color:blue" href="{{route('paymentDetail',['customer_id' => $payment->customer_id])}}">
                    #{{$payment->customer_id}}
                  </a>
                </td>
                <td class="px-6 py-4 font-semibold" >
                  @if($payment->payment_method === "online")
                    <span style="color:green">{{$payment->payment_method }}</span>
                  @else
                    <span style="color:blue">{{$payment->payment_method }}</span>
                  @endif
                </td>
                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white">
                {{$payment->tax}}
                ...
                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white">
                  @if($payment->payment_status === "Pending")
                    <span style="color:blue">{{$payment->payment_status}}</span>
                  @else
                    <span style="color:green">{{$payment->payment_status}}</span>
                  @endif
                </td>
                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white">
                {{$payment->date}}
