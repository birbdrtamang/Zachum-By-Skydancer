...
<div class="p-4 sm:ml-64" style="margin-top:90px"> 
    ...
    <h2 class="text-gray-900 dark:text-white text-lg font-medium mb-4">Create a New Event
    </h2>
    ...
    <div class="py-6 px-4 mx-auto max-w-2xl lg:py-16">
      ...
      <form action="{{route('createEvent.post')}}" method="POST" enctype="multipart/form-data">
        @csrf
          <div class="grid gap-4">
              <div class="sm:col-span-2">
                  <label for="eventTitle" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Event Title</label>
                  <input type="text" name="eventTitle" id="eventTitle" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type Event Title" required="">
              </div>
              ...
              <div class="flex items-center justify-center w-full">
                <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                  <div class="flex flex-col items-center justify-center pt-5 pb-6">
                    ...
                    <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold">Click to upload an Event Poster</span> or drag and drop</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400">PNG or JPG (MAX. 800x400px)</p>
                  </div>
                  <input name="image" accept="image/png, image/jpeg" id="dropzone-file" type="file" class="hidden" />
                </label>
                </div> 
...
@if(Session::has('success'))
            <script>
                ...
                .then(function() {
                    window.location.href = "{{ route('zevents') }}";
                });
            </script>
@endif
