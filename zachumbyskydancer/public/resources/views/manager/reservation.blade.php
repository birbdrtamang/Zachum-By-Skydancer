...
<div class="p-4 sm:ml-64" style="margin-top:90px"> 
    ...
    <h2 class="text-gray-900 dark:text-white text-lg font-medium mb-4">Reservations</h2>
          ...
          @foreach($items as $item)
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
               <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white">
                ...
                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white">
                  <a style="color:blue" href="{{route('zreservationPreview',['customer_id' => $item->customer_id,'reservation_id' => $item->reservation_id])}}">
                    #{{$item->customer_id}}
                  </a>
                </td>
                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white">
                ...
                <td class="px-6 py-4">
                  <form action="{{route('deleteReservation',['reservation_id' => $item->reservation_id])}}" method="POST">
                      @csrf
                      @method('DELETE')
