...
<div class="p-4 sm:ml-64" style="margin-top:90px"> 
    <h2 class="text-gray-900 dark:text-white text-lg font-medium mb-4">Payment Details</h2>
...
<div class="flex rounded-lg bg-white flex-col shadow-md">
    <div class="flex" style="justify-content: space-between; flex-grow: 1; width: 100%;">
        ...
        <div class="max-w-sm p-6">
            ...
            <p class="font-normal text-gray-500 dark:text-gray-400">Ordered By: <strong>{{$customers->name}}</strong></p>
