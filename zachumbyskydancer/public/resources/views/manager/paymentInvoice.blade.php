...
<div class="p-4 sm:ml-64" style="margin-top:90px"> 
    ...
    <h2 class="text-gray-900 dark:text-white text-lg font-medium mb-4">Order Details</h2>
...
<div class="flex rounded-lg bg-white flex-col shadow-md">
    <div class="flex" style="justify-content: space-between; flex-grow: 1; width: 100%;">
        ...
        <div class="max-w-sm p-6">
            <h5 class="text-gray-500 dark:text-white text-lg font-medium mb-2">Payment_ID: #{{$paymentDetail->payment_id}}</h5>
            <p class="font-normal text-gray-500 dark:text-gray-400 ">Payment Method: <span style="text-transform:capitalize;color:green;font-weight:bold">{{$paymentDetail->payment_method}}</span></p>
            <p class="font-normal text-gray-500 dark:text-gray-400">Payment Status: <span style="color:green;font-weight:bold">{{$paymentDetail->payment_status}}</span></p>
            <p class="font-normal text-gray-500 dark:text-gray-400">Jrnl No.: <span style="font-weight:600;color:#333">{{$paymentDetail->Jrl_No}}</span></p>
            <p class="font-normal text-gray-500 dark:text-gray-400">Date/Time: {{$paymentDetail->date}}</p>

        </div>
        <!-- bill amount details 
        <div class="max-w-sm p-6">
            <h5 class="text-gray-500 dark:text-white text-lg font-medium mb-2">Amount Details</h5>
            <p class="font-normal text-gray-500 dark:text-gray-400">Tax: Nu 25/-</p>
            <p class="font-normal text-gray-500 dark:text-gray-400">Service Charge: Nu 25/- </p>
            <p class="font-bold text-gray-600 dark:text-gray-500">Grand Total: 540/-</p>
        </div> -->
    </div>

    <div class="flex border border-gray-300 m-4" >
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg w-full">
               <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                  ...
                  <tbody>
                    @foreach($items_with_quantities as $item)
